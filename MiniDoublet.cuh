...
namespace SDL
{
    ...
    void transferMDsInExplicitMemory(struct miniDoublets& mdsInGPU,struct miniDoublets& mdsInHost, unsigned int maxMDs,unsigned int nModules);
    void transferbackMDsInExplicitMemory(struct miniDoublets& mdsInGPU,struct miniDoublets& mdsInHost, unsigned int maxMDs,unsigned int nModules);
    //for successful MDs
