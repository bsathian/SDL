...
__host__ __device__ const float& SDL::Hit::x() const
{
    return x_;
}

__host__ __device__ const float& SDL::Hit::y() const
{
    return y_;
}

__host__ __device__ const float& SDL::Hit::z() const
{
    return z_;
}
...
__host__ __device__ const float& SDL::Hit::rt() const
{
    return rt_;
}

__host__ __device__ const float& SDL::Hit::phi() const
{
    return phi_;
}

__host__ __device__ const float& SDL::Hit::eta() const
{
    return eta_;
}

__host__ __device__ const int& SDL::Hit::idx() const
{
    return idx_;
}
...
__host__ __device__ float SDL::Hit::deltaPhi(const SDL::Hit& hit) const
{
    return SDL::MathUtil::Phi_mpi_pi(hit.phi() - phi_);
}

__host__ __device__ float SDL::Hit::deltaPhiChange(const SDL::Hit& hit) const
{
    /*
